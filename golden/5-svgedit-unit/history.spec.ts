...
test.describe('history', function () {
  ...
  */
  ...
  test('Test svgedit.history package', async function ({ page }) {
    assert.ok(history);
    ...
    assert.equal(
      typeof history.MoveElementCommand,
      typeof function () {
        /* empty fn */
      }
    );
    assert.equal(
      typeof history.InsertElementCommand,
      typeof function () {
        /* empty fn */
      }
    );
    assert.equal(
      typeof history.ChangeElementCommand,
      typeof function () {
        /* empty fn */
      }
    );
    assert.equal(
      typeof history.RemoveElementCommand,
      typeof function () {
        /* empty fn */
      }
    );
    assert.equal(
      typeof history.BatchCommand,
      typeof function () {
        /* empty fn */
      }
    );
    assert.equal(
      typeof history.UndoManager,
      typeof function () {
        /* empty fn */
      }
    );
  ...
  test('Test UndoManager methods', async function ({ page }) {
    assert.ok(undoMgr);
    ...
    assert.equal(
      typeof undoMgr.addCommandToHistory,
      typeof function () {
        /* empty fn */
      }
    );
    assert.equal(
      typeof undoMgr.getUndoStackSize,
      typeof function () {
        /* empty fn */
      }
    );
    assert.equal(
      typeof undoMgr.getRedoStackSize,
      typeof function () {
        /* empty fn */
      }
    );
    assert.equal(
      typeof undoMgr.resetUndoStack,
      typeof function () {
        /* empty fn */
      }
    );
    assert.equal(
      typeof undoMgr.getNextUndoCommandText,
      typeof function () {
        /* empty fn */
      }
    );
    assert.equal(
      typeof undoMgr.getNextRedoCommandText,
      typeof function () {
        /* empty fn */
      }
    );
  ...
  test('Test UndoManager.addCommandToHistory() function', async function ({
    page,
  }) {
  ...
  test('Test UndoManager.getUndoStackSize() and getRedoStackSize() functions', async function ({
    page,
  }) {
    undoMgr.addCommandToHistory(new MockCommand());
    undoMgr.addCommandToHistory(new MockCommand());
  ...
  test('Test UndoManager.resetUndoStackSize() function', async function ({
    page,
  }) {
    undoMgr.addCommandToHistory(new MockCommand());
    undoMgr.addCommandToHistory(new MockCommand());
  ...
  test('Test UndoManager.getNextUndoCommandText() function', async function ({
    page,
  }) {
  ...
  test('Test UndoManager.getNextRedoCommandText() function', async function ({
    page,
  }) {
  ...
  test('Test UndoManager.undo() and redo() functions', async function ({
    page,
  }) {
    let lastCalled = null;
    ...
    cmd1.apply = function () {
      lastCalled = 'cmd1.apply';
    };
    cmd2.apply = function () {
      lastCalled = 'cmd2.apply';
    };
    cmd3.apply = function () {
      lastCalled = 'cmd3.apply';
    };
    cmd1.unapply = function () {
      lastCalled = 'cmd1.unapply';
    };
    cmd2.unapply = function () {
      lastCalled = 'cmd2.unapply';
    };
    cmd3.unapply = function () {
      lastCalled = 'cmd3.unapply';
    };
  ...
  test('Test MoveElementCommand', async function ({ page }) {
    let move = new history.MoveElementCommand(
      this.div3,
      this.div1,
      this.divparent
    );
    ...
    assert.equal(
      this.divparent.firstElementChild.nextElementSibling,
      this.div1
    );
  ...
  test('Test RemoveElementCommand', async function ({ page }) {
  ...
  test('Test ChangeElementCommand', async function ({ page }) {
    ...
    change = new history.ChangeElementCommand(this.div1, { '#text': null });
    ...
    change = new history.ChangeElementCommand(rect, { '#href': '#oldhref' });
  ...
  test('Test BatchCommand', async function ({ page }) {
    let concatResult = '';
    MockCommand.prototype.apply = function () {
      concatResult += this.text;
    };
