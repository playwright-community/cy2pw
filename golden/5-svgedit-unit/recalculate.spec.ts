...
test.describe('recalculate', function () {
  ...
  test('Test recalculateDimensions() on rect with identity matrix', async function ({
    page,
  }) {
    setUpRect();
  ...
  test('Test recalculateDimensions() on rect with simple translate', async function ({
    page,
  }) {
    setUpRect();
  ...
  test('Test recalculateDimensions() on text w/tspan with simple translate', async function ({
    page,
  }) {
    setUpTextWithTspan();
    elem.setAttribute('transform', 'translate(100,50)');
