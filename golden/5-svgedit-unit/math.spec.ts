...
test.describe('math', function () {
  ...
  test('Test svgedit.math package', async function ({ page }) {
    assert.ok(math);
    assert.ok(math.transformPoint);
    assert.ok(math.isIdentity);
    assert.ok(math.matrixMultiply);
    assert.equal(
      typeof math.transformPoint,
      typeof function () {
        /* empty fn */
      }
    );
    assert.equal(
      typeof math.isIdentity,
      typeof function () {
        /* empty fn */
      }
    );
    assert.equal(
      typeof math.matrixMultiply,
      typeof function () {
        /* empty fn */
      }
    );
  ...
  test('Test svgedit.math.transformPoint() function', async function ({
    page,
  }) {
  ...
  test('Test svgedit.math.isIdentity() function', async function ({ page }) {
  ...
  test('Test svgedit.math.matrixMultiply() function', async function ({
    page,
  }) {
    ...
    assert.ok(
      isIdentity(I),
      'Expected identity matrix when translating there and back'
    );
    ...
    assert.ok(
      isIdentity(I),
      'Expected identity matrix when rotating there and back'
    );
    ...
    assert.ok(
      isIdentity(I),
      'Expected identity matrix when scaling up and down'
    );
    ...
    assert.ok(
      isIdentity(I),
      'Expected identity matrix when multiplying a matrix by its inverse'
    );
  ...
  test('Test svgedit.math.transformBox() function', async function ({ page }) {
