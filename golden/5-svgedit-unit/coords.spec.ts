...
test.describe('coords', function () {
  ...
  test('Test remapElement(translate) for rect', async function ({ page }) {
  ...
  test('Test remapElement(scale) for rect', async function ({ page }) {
    const rect = document.createElementNS(NS.SVG, 'rect');
    rect.setAttribute('width', '250');
    rect.setAttribute('height', '120');
    this.svg.append(rect);
  ...
  test('Test remapElement(translate) for circle', async function ({ page }) {
  ...
  test('Test remapElement(scale) for circle', async function ({ page }) {
    const circle = document.createElementNS(NS.SVG, 'circle');
    circle.setAttribute('cx', '200');
    circle.setAttribute('cy', '150');
  ...
  test('Test remapElement(translate) for ellipse', async function ({ page }) {
  ...
  test('Test remapElement(scale) for ellipse', async function ({ page }) {
    const ellipse = document.createElementNS(NS.SVG, 'ellipse');
    ellipse.setAttribute('cx', '200');
    ellipse.setAttribute('cy', '150');
  ...
  test('Test remapElement(translate) for line', async function ({ page }) {
  ...
  test('Test remapElement(scale) for line', async function ({ page }) {
    const line = document.createElementNS(NS.SVG, 'line');
    line.setAttribute('x1', '50');
    line.setAttribute('y1', '100');
    line.setAttribute('x2', '120');
  ...
  test('Test remapElement(translate) for text', async function ({ page }) {
