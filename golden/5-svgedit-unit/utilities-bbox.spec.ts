...
test.describe('utilities bbox', function () {
  /**
  ...
  test('Test getBBoxWithTransform and no transform', async function ({ page }) {
  ...
  test('Test getBBoxWithTransform and a rotation transform', async function ({
    page,
  }) {
    const { getBBoxWithTransform } = utilities;
  ...
  test('Test getBBoxWithTransform with rotation and matrix transforms', async function ({
    page,
  }) {
    const { getBBoxWithTransform } = utilities;
    ...
    let matrix =
      'matrix(1,0,0,1,' + txInRotatedSpace + ',' + tyInRotatedSpace + ')';
    let elem = mockCreateSVGElement({
      element: 'path',
      attr: {
        id: 'path',
        d: 'M10,10 L20,20',
        transform: 'rotate(45 10,10) ' + matrix,
      },
    });
    svgroot.append(elem);
    let bbox = getBBoxWithTransform(
    ...
    elem = mockCreateSVGElement({
      ...
      attr: {
        ...
        width: '10',
        height: '20',
        transform: 'rotate(90 15,20) ' + matrix,
      },
    });
    svgroot.append(elem);
    bbox = getBBoxWithTransform(
    ...
    elem = mockCreateSVGElement({
      ...
      attr: {
        ...
        height: rect.height,
        transform:
          'rotate(' + angle + ' ' + origin.x + ',' + origin.y + ') ' + matrix,
      },
    });
    svgroot.append(elem);
    bbox = getBBoxWithTransform(
    ...
    elem = mockCreateSVGElement({
      ...
      attr: {
        ...
        rx: '50',
        ry: '50',
        transform: 'rotate(45 100,100) ' + matrix,
      },
    });
    svgroot.append(elem);
    bbox = getBBoxWithTransform(
  ...
  test('Test getStrokedBBox with stroke-width 10', async function ({ page }) {
  ...
  test("Test getStrokedBBox with stroke-width 'none'", async function ({
    page,
  }) {
    const { getStrokedBBox } = utilities;
  ...
  test('Test getStrokedBBox with no stroke-width attribute', async function ({
    page,
  }) {
    const { getStrokedBBox } = utilities;
